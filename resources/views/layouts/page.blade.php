...
<body class="bg-emerald-100 hr-solutions-bg nunito-font">
    <div id="app" class="flex flex-col h-screen">
        ...
        <div class="flex flex-1 max-sm:flex-col-reverse">
                ...
                <nav class="text-slate-100 fixed top-12 max-sm:top-auto max-sm:bottom-0 max-sm:w-full w-1/6 max-md:w-14 max-sm:z-30 max-sm:bg-emerald-400">
                    <ul class="mt-6 max-sm:mt-auto max-sm:px-7 max-sm:flex max-sm:justify-between">
                        <li class="mb-2 max-sm:mb-0">
                            ...
                            {{ route('admin.index') }}
                            @endadmin
                            " class="flex items-center py-2 max-sm:py-3 ps-3 max-sm:ps-0 text-slate-100 hover:text-emerald-600 focus:text-emerald-600 focus:fill-emerald-600 transition-all ease-in-out">
                        ...
                        @applicant
                        <li class="mb-2 max-sm:mb-0">
                            <a href="#" class="flex items-center py-2 max-sm:py-3 ps-3 max-sm:ps-0 text-slate-100 hover:text-emerald-600 focus:text-emerald-600 transition-all ease-in-out">
                        ...
                        <li class="mb-2 max-sm:mb-0">
                            <a href="#" class="flex items-center py-2 max-sm:py-3 ps-3 max-sm:ps-0 text-slate-100 hover:text-emerald-600 focus:text-emerald-600 transition-all ease-in-out overflow-hidden">
                        ...
                        <li class="mb-2 max-sm:mb-0">
                            <a href="#" class="flex items-center py-2 max-sm:py-3 ps-3 max-sm:ps-0 text-slate-100 hover:text-emerald-600 focus:text-emerald-600 transition-all ease-in-out">
                                ...
                                <span class="ml-3 max-md:translate-x-44 max-md:hidden truncate">search about fontawesom</span>
                            </a>
                        </li>
                        @applicant
                        <li class="mb-2 max-sm:mb-0">
            ...
            <main class="flex-1 overflow-y-auto items-center px-1">
...
<script>
    const logtoggle = document.getElementById('navbarDropdown');
    const mdtoggle = document.getElementById('burgerDown');
